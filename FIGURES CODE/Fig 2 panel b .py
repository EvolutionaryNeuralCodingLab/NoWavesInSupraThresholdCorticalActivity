...
class Display:
    ...
    def plot_frames(self, space, scale):
        ...
        frame_indices = [3, 17, 21, 27, 35, 43, 52, 69]
        ...
        fig, axes = plt.subplots(2, cols, figsize=figsize_in, dpi=350, gridspec_kw={'hspace': 0.05, 'wspace': 0})
        ...
        plt.savefig('calcium_optic_flow.pdf',bbox_inches='tight')
